<template>
  <div id="app">
    <div id="mainChat">
      ...
      <div id="inputArea">
        <div id="inputAreaSub">
          <textarea v-model="message" name="chat" id="chatArea" cols="15" rows="1" @keyup="emitMessage($event)"></textarea>
...
export default {
  ...
  data () {
    return {
      theme: 'light',
      chat: [
        {name: 'bob', text: 'LOLOL', color: 'red'},
        {name: 'bob', text: 'LOLOL', color: 'blue'},
        {name: 'bob', text: 'LOLOL', color: 'purple'}
      ],
      message: '',
      showEmojiMenu: false 
    }
